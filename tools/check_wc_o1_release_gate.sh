...
run_docs_checks() {
  ...
  # (The private ktdeque_experimental library was removed in the 2026-06
  #  re-curation; the catenable deque is being rebuilt fresh from KT99 §6.)
}
...
run_catenable_checks() {
  printf 'SKIP: the experimental catenable surface (Cadeque9 et al.) was removed\n'
  printf 'in the 2026-06 rebuild re-curation and is preserved on the\n'
  printf 'archive/pre-rebuild-2026-06-02 branch.  The canonical catenable deque\n'
  printf 'is being rebuilt fresh from KT99 §6 (kb/spec/catenable-concat-invariant.md);\n'
  printf 'this profile will gate that build.\n'
}
