...
- WEB PAGE: kb/viennot-comparison.html — self-contained static page
  (house style of kb/cadeque8-formalization.html) with 9 log-log SVG
  scaling charts, qualitative comparison, full table, verdict.
  Generated by bench/render-comparison-page.py from the latest dated
  bench/results/cadeque-compare-*.md (rerun after make bench-cadeque).
